...
// Refatorando código com loop
const elements = [
  { id: "horizontal", property: "horizontal" },
  { id: "vertical", property: "vertical" },
  { id: "blur", property: "blur" },
  { id: "spread", property: "spread" },
  { id: "color", property: "color" },
  { id: "opacity", property: "opacity" },
  { id: "inset", property: "inset", type: "checkbox" },
];
...
elements.forEach((element) => {
  ...
  inputElement.addEventListener("input", (e) => {
    const value =
      element.type === "checkbox" ? e.target.checked : e.target.value;
    boxShadow.updateValue(element.property, value);
  });
});
...
rulesArea.addEventListener("click", () => {
  //Expressão regular para remover linhas em branco
